...
export default function WorkoutVideoScreen({ navigation, route }) {
  ...
  async function continueWorkout() {
    ...
    if (recordedWorkout) {
      ...
      exerciseInputObject.reps = parseInt(numberOfReps);
      exerciseInputObject.weight = parseInt(amountOfWeight);
      exerciseInputObject.time = parseInt(minutes * 60 + seconds);
      ...
      >
        {exercises[currentExercise].reps ? (
          <View style={{ marginLeft: "4%", marginTop: "4%" }}>
            <Text style={{ paddingBottom: "2%" }}>Reps</Text>
            <TextInput
              style={{
                borderRadius: 10,
                borderWidth: 1,
        ...
        {exercises[currentExercise].time ? (
          <View style={{ marginLeft: "4%", marginTop: "4%" }}>
            <Text style={{ paddingBottom: "2%" }}>Time</Text>
            <TouchableHighlight
              onPress={() => {
        ...
        {exercises[currentExercise].weight ? (
          <View style={{ marginLeft: "4%", marginTop: "4%" }}>
            <Text style={{ paddingBottom: "2%" }}>Weight</Text>
            <TextInput
              style={{
                borderRadius: 10,
                borderWidth: 1,
